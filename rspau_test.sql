...
-- Dumping structure for table laravel.diagnosa
...
-- Dumping structure for table laravel.pasien
CREATE TABLE IF NOT EXISTS `pasien` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pasiens_id_diagnosa_foreign` (`id_diagnosa`),
  CONSTRAINT `pasiens_id_diagnosa_foreign` FOREIGN KEY (`id_diagnosa`) REFERENCES `diagnosa` (`id`)
